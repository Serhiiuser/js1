...
//     titleItem.innerText = arrayElement.title;
//
//     let monthDurationItem = document.createElement('div')
//     monthDurationItem.innerText = arrayElement.monthDuration;
//
//     let hourDurationItem =document.createElement('div')
//     hourDurationItem.innerText= arrayElement.hourDuration
//
//     let modulesItem = document.createElement('ul')
//     for (const modulesItemElement of arrayElement.modules) {
//         let modules = document.createElement('li');
//         modules.innerText = modulesItemElement;
//
//     }
//     divItem.appendChild(titleItem);
//     divItem.appendChild(monthDurationItem);
//     divItem.appendChild(hourDurationItem);
//     divItem.appendChild(modulesItem);
